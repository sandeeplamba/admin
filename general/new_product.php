...
{	
				...
				if($insert_id > 0)
				{
					?>
						 ...
						 window.location.href= "general/new_product.php";
						 </script>
                    <?php     
					} }
								 ?> 
...
{	     
				 ...
				 $data			=	$_POST;	
				$fields			=	 array("cat_id", "subcat_id", "product_name", "product_desc", "product_price");
				$static_fields	=	" , product_addedon='". $time ."', product_status='1'";
               if($_FILES['product_pic']['name']	!=	"")
				{		
					$fields[]	=	'product_pic';
				 $data['product_pic']	=	$_FILES['product_pic']['name'];
					move_uploaded_file($_FILES['product_pic']['tmp_name'], "./../images/".$_FILES['product_pic']['name']);
				}
				...
				if($insert_id > 0)
				{
					?>
                    <script type="text/javascript">
						 alert("Product Updated Succssfully");
						 </script>
                    <?php     
					}  }
								 ?>  
    ...
    <section class="content">
      ...
      <div class="box box-default">
		...
		<form class="form-horizontal" method="post" enctype="multipart/form-data">
              <div class="box-body">
			    <?php 
	if(isset($_GET['product_id']) && isset($_GET['val']))
	{
	 if($_GET['val']  == "edit")
	 {	  	
	...
	?>
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Product Pic</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="product_picc" name="product_picc" placeholder="Product Pic" value="<?php echo $ins['product_pic']; ?>">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Product Name" value="<?php echo $ins['product_name']; ?>">
                  </div>				  
                </div>
                 <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Product Description</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" id="product_desc" name="product_desc" placeholder="Product Description"><?php echo $ins['product_desc']; ?></textarea>
                  </div>				  
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Product Price</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="product_price" name="product_price" placeholder="Product Price" value="<?php echo $ins['product_price']; ?>">
	 ...
	 <?php } } } else { ?>
      ...
      <!-- /.row -->
		  ...
		  <th>Update</th>
                ...
                $product_name        =   array_column($insert_id, 'product_name');
				$product_addedon = array_column($insert_id, 'product_addedon');	
                $product_status = array_column($insert_id, 'product_status');
				$count = count($product_id);				
				for($i =0; $i<$count; $i++)
				{
								 ?> 
                <tr>
				   <td style="display:none;"><input type ="checkbox" id="product_id" name="product_id" class="product_id" value="<?php echo $product_id[$i]; ?>"></td>
                  <td style="display:none;"><?php echo $product_id[$i]; ?></td>
				  <td><?php 
                                  $table = "tbl_category";
				  ...
				  <td><?php echo date("d-m-Y", $product_addedon[$i]); ?></td>
				  <td><?php echo $product_status[$i]; ?></td>				  
				  <td style="cursor: pointer;"><input type="hidden" name="edit_icon" class="edit_icon" value="<?php echo $product_id[$i]; ?>">
